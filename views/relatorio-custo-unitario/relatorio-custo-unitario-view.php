...
$adm_uri = HOME_URI . '/relatorio-custo-unitario/';
...
<div style="padding: 35px;" align="center" class="card">
	...
	<section class="container">
		<div class="row">
		<h3 class="center-align">RELATÓRIO CUSTO UNITÁRIO</h3>
	...
	<?php if(!empty($lista)): foreach ($lista as $fetch_custo): ?>
			...
			<tr>
				<td><?php echo $fetch_custo['tipo_descricao']?></td>
				<td><?php echo $fetch_custo['produtividade']?></td>
				<td><?php echo $fetch_custo['unidade']?></td>
				<td><?php echo $fetch_custo['total']?></td>
				<td><?php echo $fetch_custo['unitario']?></td>	
				<td>
					<a href="#" style="color: #000000" onclick="window.print();">
